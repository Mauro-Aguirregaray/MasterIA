...
import simulator.animator as animator
import simulator.background as background
import simulator.logic as logic
import simulator.sprites as sprites
import simulator.synchronizer as synchronizer
...
def getConfiguration():
    ...
    return (initial_state,sequence,number_of_disks,disk_height)
...
def main():
    ...
    initial_state = configuration[0]
    sequence = configuration[1]
    number_of_disks = configuration[2]
    disk_height = configuration[3]
